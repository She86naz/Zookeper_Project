...
habitat_choice = input("Which habitat # do you need?")

while habitat_choice != "exit":
   habitat_choice = int(habitat_choice)
   print(animals[habitat_choice])
   habitat_choice = input("Which habitat # do you need?")

print("See you!")# Write your code here
